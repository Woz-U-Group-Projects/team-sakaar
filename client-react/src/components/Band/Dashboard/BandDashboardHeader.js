           ...
           <Navbar className='' bg="light" expand="lg" fixed='top'>
               ...
               <Navbar.Collapse id="basic-navbar-nav" className='justify-content-end'>
                  <Nav className="">
                     ...
                     <Nav.Link href="/logout" title='logout'><LogoutBox className='text-danger' style={{color:''}}  size='35'/></Nav.Link>

                     <NavDropdown title={<SettingsApplications className='bg-info' style={{color:'white'}} size='32'/>} id="basic-nav-dropdown" className='' alignRight>
